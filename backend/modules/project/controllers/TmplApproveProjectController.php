...
use backend\modules\project\models\TmplApproveProjectSearch;
 ...
 */
class TmplApproveProjectController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new TmplApproveProjectSearch();
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
			...
			if($model->is_active == 1){
				TmplApproveProject::updateAll(['is_active' => 0], ['<>', 'id', $id]);
			}
    ...
    {
        if (($model = TmplApproveProject::findOne($id)) !== null) {
            return $model;
        }

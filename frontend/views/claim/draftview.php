...
<div class="box-title">* Sila klik butang [Kembali Kemaskini] untuk kemaskini dan hantar</div>
</div>
...
<a href="<?=Url::to(['claim/update', 'id' => $model->id])?>" class="btn btn-warning"> <span class="glyphicon glyphicon-pencil"></span> Kembali Kemaskini</a>
